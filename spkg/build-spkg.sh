...
arch=x86_64
numjobs=1
package=$pkgname-$pkgver-$arch-2slint
source=("spkg-1.6.tar.gz")
docs=()
...
{ 
    ...
    ./autogen.sh;
    ./configure --prefix=/usr --bindir=/sbin --libdir=/usr/lib${LIBDIRSUFFIX} --mandir=/usr/man --enable-static-spkg=only --build=$arch-slackware-linux;
    make || return 1;
