...
# Includes in Slint package accountsservice
...
# Downloaded from:
# http://bazaar.launchpad.net/~linaro-graphics-wg/linaro-graphics-tests/trunk/view/head:/scripts/user_xsession.py
# And slightly modified for Python3 by Didier
