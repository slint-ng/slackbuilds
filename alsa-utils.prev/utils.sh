# This shell snippet mostly borrowed to Debian
# bug number refer to Debian bug tracker unless otherwise stated.
# Didier Spaier <didier~at~slint~dot~fr>

bugout()
{
	echo "/usr/share/alsa/utils.sh: Programming error"
}
...
sanify_levels_on_card()
{
	...
	unmute_and_set_level "Headphone" "90%" # Was 70%
	unmute_and_set_level "PCM" "90%" # Was 80%
	...
	unmute_and_set_level "Front" "100%" # Was 80%
	unmute_and_set_level "Master Front" "100%" # Was 80%
