...
fenrir: fenrir (A user space console screen reader written in python3)
fenrir: 
fenrir: Developers: Chrys, Storm Dragon and contributors.
fenrir: Home page: https://git.stormux.org/storm/fenrir
fenrir: 
fenrir: 
fenrir: 
fenrir: 
